...
\subsection{Permutação}
    ...
    As imagens aqui foram geradas com os mesmos comandos encontrados na \cref{sec:pequeno} e \cref{sec:binarios}. A única diferença é a \textit{flag} \mintinline{bash}{-p}, apresentada na \cref{sec:permutacao}.
